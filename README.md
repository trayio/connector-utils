...
<dt><a href="#validatePagination">validatePagination(pageSize, minPageSize, maxPageSize)</a></dt>
...
It's important to note that this method will remove objects if they become empty
Ryans-MacBook-Pro:lib ryan$ jsdoc2md ddl.js deepMapKeys.js errors.js lookup.js removeEmptyObjects.js validatePagination.js
## Classes
...
<a name="validatePagination"></a>

## validatePagination(pageSize, minPageSize, maxPageSize)
...
| Param | Type | Description |
| --- | --- | --- |
| pageSize | <code>Integer</code> | The page size specified by user input. |
| minPageSize | <code>Integer</code> | The minimum page size specified by the API. |
| maxPageSize | <code>Integer</code> | The maximum page size specified by the API. |
