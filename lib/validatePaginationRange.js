 ...
 * @param {Integer|String} minRange The minimum range specified by the API.
 * @param {Integer|String} maxRange The maximum range specified by the API.
 * @param {String} inputName The name of the input the range is associated with.
 * @example
 *
