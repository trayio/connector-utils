...
const baseErrorWithBody = (code, message, body) => {
	if (!body) {
		throw new Error(
			`Argument Error: Error functions required 'body' argument. Throw appropriate class Error if body is not required.`,
		);
	}
	return {
		code,
...
const userInputErrorRejection = (message = ERROR_MESSAGES.USER_INPUT, body) => {
	return baseErrorWithBody(ERROR_CODES.USER_INPUT, message, body);
};
...
const connectorErrorRejection = (message = ERROR_MESSAGES.USER_INPUT, body) => {
	return baseErrorWithBody(ERROR_CODES.USER_INPUT, message, body);
};
...
const apiErrorRejection = (message = ERROR_MESSAGES.API, body) => {
	return baseErrorWithBody(ERROR_CODES.API, message, body);
};
...
const oauthErrorRejection = (message = ERROR_MESSAGES.OAUTH, body) => {
	return baseErrorWithBody(ERROR_CODES.OAUTH, message, body);
};
...
const noTriggerErrorRejection = (message = ERROR_MESSAGES.NO_TRIGGER, body) => {
	return baseErrorWithBody(ERROR_CODES.NO_TRIGGER, message, body);
};
